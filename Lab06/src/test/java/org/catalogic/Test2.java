...
class Test2 {
    ...
    /* TASk_2 */
    @Test
    void getStudentByName_InsertInvalidName_ThrowsNotFoundException() throws ExistingUserException {
        assertThrows(CatalogException.class, () -> defenseAgainstDarkArts.getStudentByName("student"));
    }

    /* TASk_3 */
    @Test
    void getStudentByName_ValidStudent_PositiveScenario() throws ExistingUserException {
        /* IF I PASS, YOU PASS */
        defenseAgainstDarkArts.addStudent((Student) UsersFactory.create(UserType.STUDENT, "Hermione Granger"));

        assertDoesNotThrow(() -> defenseAgainstDarkArts.getStudentByName("Hermione Granger"));
