...
public class CatalogReport {
    ...
    public Double getGradeOnASpecificWeekForStudent(Catalog catalog, String name, Integer laboratoryNumber) {
        try {
            Student student = catalog.getStudentByName(name);
            ...
            catalogException.printStackTrace();
            return 0.0;
        }

    }

    public Double getFinalGradeForStudent(Catalog catalog, String name) {
        try {
    ...
    public boolean isStudentPassing(Catalog catalog, String name) {
